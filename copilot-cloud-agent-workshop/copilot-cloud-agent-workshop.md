...
> A complete, guided workshop on the **GitHub Copilot cloud agent** (also called the _coding agent_): what it is, how it differs from other Copilot agents, how to trigger, customize, run, and steer it — with step-by-step instructions and screenshots from a live demo repository. Everything in this workshop runs on **github.com**: first **create a plan**, then **create issues**, then **assign them to Copilot**.
...
- [GitHub Copilot Cloud Agent — Hands-On Workshop](#github-copilot-cloud-agent--hands-on-workshop)
  - [Index](#index)
  ...
  - [5. How to trigger it](#5-how-to-trigger-it)
    - [5.1 The Agents dashboard — create a issue](#51-the-agents-dashboard--create-a-issue)
    - [5.2 Assign an issue](#52-assign-an-issue)
      - [5.2.1. How to steer it (get the best results)](#521-how-to-steer-it-get-the-best-results)
  ...
  - [7. How to customize it](#7-how-to-customize-it)
    ...
    - [7.3 Custom agents, hooks, skills](#73-custom-agents-hooks-skills)
  - [8. Limitations \& cost](#8-limitations--cost)
  - [9. Workshop labs](#9-workshop-labs)
...
_The demo repo `insure-well-agentic-sdlc-ghe` (React + Spring Boot insurance app), with the **Agents** tab in the repository navigation._
...
_A completed session: model used, AI credits, "Setting up environment", agent firewall, repo clone, and the default MCP servers._
...
Open the **Copilot Chat** within your repository, select the AI model that you preferred.
![Copilot-chat](images/copilot-chat.png)

Enter the prompt below

```
Create GitHub issues to add a Policy Renewal Reminder feature to InsureWell. Don't write code yet — research the repo, produce a step-by-step plan, and propose 1 well-scoped issue with acceptance criteria.
```

<img src="images/chat-prompt.png" alt="Chat-prompt" width="300" height="420" />

Copilot will research the repo, create a plan, and propose issues. The issue will be generated in a separate issue window. You can review the plan and create the issue after reviewing it.

![Copilot-chat-issue](images/copilot-chat-issue.png)
...
_Pull requests authored by Copilot in the demo repo._

![A Copilot pull request](images/08-copilot-pr.png)
_A Copilot PR with its "Initial plan", task checklist, and a **View session** link._
...
1. **Plan:** on the **Agents** tab, ask Copilot to _create a plan_ for a feature and propose issues; review the plan in the session.
